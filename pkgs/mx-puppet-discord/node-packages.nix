...
let
  sources = {
    ...
    "@types/node-14.14.14" = {
      ...
      version = "14.14.14";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-14.14.14.tgz";
        sha512 = "UHnOPWVWV1z+VV8k6L1HhG7UbGBgIdghqF3l9Ny9ApPghbjICXkUJSd/b9gOgQfjM1r+37cipdw/HJ3F6ICEnQ==";
      };
    };
    ...
    "mx-puppet-bridge-0.1.2" = {
      name = "mx-puppet-bridge";
      packageName = "mx-puppet-bridge";
      version = "0.1.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/mx-puppet-bridge/-/mx-puppet-bridge-0.1.2.tgz";
        sha512 = "IZH9UWPfNL1ngadV+RWW2e7DpyNk+nqUmzk9A0cGyiLiUIQV6B0rBdRLJtTZ+W4H1h+kjxY7udaoKYxTEc2xeA==";
      };
    };
    "nan-2.14.2" = {
      name = "nan";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."ms-2.0.0"
      sources."mx-puppet-bridge-0.1.2"
      sources."nan-2.14.2"
